  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php $jobs = [
                      ["Бухгалтер", "Jan 2015 - Current", "Ведение всех участков." ], 
                      ...
                      ["Курьер", "Jun 2010 - Mar 2012", 
                        "Быстро бегаю"]
                      ];?>
        <?php foreach($jobs as $key): ?>
          <div class="w3-container">
          <h5 class="w3-opacity"><b><?=$key[0];?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$key[1];?></h6>
          <p><?=$key[2];?></p>
          <hr>
          </div>
        <?php endforeach; ?>
